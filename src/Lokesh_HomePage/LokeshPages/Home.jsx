      ...
      <section className="lokesh_home_first_section">
        ...
        <div className="lokesh_home_first-section-grid">
          <div>
            <div>
              <img
                src="https://cms-contents.pharmeasy.in/offer/c287851239f-25_off.jpg?dim=1440x0"
                alt=""
              />
            </div>
          ...
          <div>
            <div>
              <img
                src="https://cms-contents.pharmeasy.in/offer/b1cafb3a0cf-flat_27_off.jpg?dim=1440x0"
                alt=""
              />
            </div>
          ...
          <div>
            ...
            <div>Log in to view more offers</div>
          </div>
        </div>
      </section>
