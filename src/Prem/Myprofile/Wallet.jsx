      ...
      <Box w={"92%"} m="6rem auto auto auto" display={"flex"}>
        ...
        >
          ...
          <Image
            ...
            w="30%"
            m="auto"
            src="https://assets.pharmeasy.in/web-assets/dist/2907b0cf.png"
          />
          <Text fontWeight={"bold"} fontSize="2xl" m="0rem 2rem 0rem 18rem">
            WALLET IS EMPTY
          </Text>
          <Text fontSize={"2xl"} m="0rem 2rem 0rem 15rem" color={"gray"}>
            Your Cashback is credited here.
          </Text>
        </Box>
      </Box>
      <Divider m={"5rem"} />
