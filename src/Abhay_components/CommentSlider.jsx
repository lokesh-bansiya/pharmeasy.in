    ...
    <Box width={["80%"]} position="relative" m="auto">
      <Carousel responsive={responsive} className="commentslider">
        <Box border="1px solid black" width="50%" height="300px">
          <Img
            height="150px"
            src=" https://cdn01.pharmeasy.in/dam/diagnostics/usp-images/e916484d3a2336368ce2ecf1748437e2"
          />
          <Text fontWeight="bold" mt="20px" mb="20px">
            Affordable Price
          </Text>
          <Text>
            Get the best price for the tests and package by comparing arocess
            the multiple tabs
          </Text>
        </Box>
        <Box border="1px solid black" width="50%" height="300px">
