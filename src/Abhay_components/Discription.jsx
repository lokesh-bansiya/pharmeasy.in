...
const Discription = () => {
  return (
    <Box w="80%" m="auto" display="-ms-grid" mb="30px">
      ...
      <Flex mb="15px">
        <Grid>
          ...
          <Text fontSize="13px">
            ...
            wait in a queue to get tested.
          </Text>
          <Text mt="10px" fontSize="13px">
            To bypass these hassles, PharmEasy has set up an extensive network
            of reputed pathological laboratories in India. One such lab is
      ...
      <Flex mb="15px">
        <Grid>
          <Text>Lab tests at your doorstep</Text>
          <Text fontSize="13px">
      ...
      <Flex mb="15px">
        <Grid>
          ...
          <Text fontSize="13px">
            ...
            the selected slot and collect your sample for processing at our
