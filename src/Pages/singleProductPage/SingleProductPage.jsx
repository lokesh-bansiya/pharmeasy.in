        ...
        <Box mt="5%" w="40%" h="auto" textAlign="start">
          ...
          >
            ...
            <Box mt="10px" display="flex">
              <Image
                w="35px"
                src="https://cdn01.pharmeasy.in/dam/products_otc/270552/revital-h-men-multivitamin-with-calcium-zinc-ginseng-for-immunity-strong-bones-energy-30-capsules-2-1654077741.jpg"
              />

              <Text color="teal.600" ml="4" fontSize="xs">
                Get additional 10% off on Health products
              </Text>
            </Box>
          </Box>
        </Box>
