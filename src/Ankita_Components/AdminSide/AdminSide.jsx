...
export const AdminSide = () => {
  ...
  async function submitEdit() {
    ...
    try {
      axios
        .patch(`${backend_url}/products/${seletedID}`, {
          img1: image,
          title: name,
          mrp: price,
      ...
      <Box display="flex">
              ...
              >
                ...
                >
                  ...
                  <div style={{ display: "flex", alignItems: "center" }}>
                    <p style={{ fontWeight: "bold" }}>₹{el.mrp} &nbsp; </p>
                    <Flex
                      align="center"
                      justify="start"
                      px="6px"
                  ...
                  <Box display="flex" justifyContent="space-around">
                    <Button
                      onClick={() => HandleProductEdit(el._id)}
        ...
        <Modal onClose={onClose} isOpen={isOpen} isCentered>
          ...
          <ModalContent>
            ...
            <ModalFooter>
              <Button onClick={submitEdit} colorScheme="linkedin">
                Save
              </Button>
            </ModalFooter>
          </ModalContent>
