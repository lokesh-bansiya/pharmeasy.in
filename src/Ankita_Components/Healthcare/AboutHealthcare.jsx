...
export const AboutHealthcare = () => {
  ...
  return (
    <>
      ...
      >
        <Stack>
          <Text marginBottom="-0.5em" lineHeight="110%" fontWeight="bold">
        ...
        <Stack marginBottom="0em">
          ...
          <UnorderedList>
            <ListItem color={"#319795"}>
              <Text color={"#4f585e"}>8400+ Brands</Text>{" "}
            </ListItem>
            <ListItem color={"#319795"}>
              <Text color={"#4f585e"}>35K products in our stock</Text>{" "}
            </ListItem>
            <ListItem color={"#319795"}>
              <Text color={"#4f585e"}>Delivery to 22000+ pin codes</Text>{" "}
            </ListItem>
            <ListItem color={"#319795"}>
              <Text color={"#4f585e"}>Delivered to 50 lakh+ families</Text>{" "}
            </ListItem>
            <ListItem color={"#319795"}>
              <Text marginBottom="-0.5em" color={"#4f585e"}>
                Over 2M customers served
              </Text>
            </ListItem>
          </UnorderedList>
        </Stack>
        ...
        <Stack>
          ...
          <UnorderedList>
            <ListItem color={"#319795"}>
              <Text color={"#4f585e"}>
                Regular sanitization of our premises and warehouses
              </Text>
            </ListItem>
            <ListItem color={"#319795"}>
              <Text color={"#4f585e"}>
            ...
            <ListItem color={"#319795"}>
              <Text color={"#4f585e"}>No-contact door-step delivery</Text>
            </ListItem>
            <ListItem color={"#319795"}>
              <Text marginBottom="-0.5em" color={"#4f585e"}>
                Sanitized packaging
